...
```sh
cargo run \
  1bbr@10mbit+10ms+1ms \
  1bbr@50mbit+10ms+1ms \
  1bbr@100mbit+10ms+1ms \
  1bbr@1000mbit+10ms+1ms \
  ...
  1cubic@10mbit+10ms+1ms \
  1cubic@50mbit+10ms+1ms \
  1cubic@100mbit+10ms+1ms \
  1cubic@1000mbit+10ms+1ms \
  ...
  1prague@10mbit+10ms+1ms \
  1prague@50mbit+10ms+1ms \
  1prague@100mbit+10ms+1ms \
  1prague@1000mbit+10ms+1ms \
